...
LOOP_AUDIO:
    ...
    LDV b, r1               ;coeficientes b
    LDV 255baudio, r2, r6   ;move len(b-1) 
...
LOOP_SUMATORIA:
    ...
    JAL LOOP_SUMATORIA          ;loop

FUERA_LOOP:
    STV r3, r8              ;store vector r3 only value r8
    ADDI r8, r8, #1         ;++ index of what to store
    ADDI r6, r6, #1         ;++ audio part
    JAL LOOP_AUDIO          ;go next audio part